...
class Solution {
    ...
    boolean checkInRect(int x_center, int y_center, int x1, int y1, int x2, int y2){
    	return x1 <= x_center && x_center <= x2 && y1 <= y_center && y_center <= y2;
    }

    boolean checkInCircle(int radius, int x_center, int y_center, int x, int y){
