 ...
 * n, where edges[i] indicates that there is a directed edge from node i to
 * node edges[i].
 * 
 ...
 * - The nodes 5 and 6 have an edge pointing to node 7. The edge score of node
 * 7 is 5 + 6 = 11.
 ...
 * Output: 0
 * Explanation:
 * - The nodes 1 and 2 have an edge pointing to node 0. The edge score of node
 * 0 is 1 + 2 = 3.
 * - The nodes 0 and 3 have an edge pointing to node 2. The edge score of node
 * 2 is 0 + 3 = 3.
 * Nodes 0 and 2 both have an edge score of 3. Since node 0 has a smaller
 * index, we return 0.
 * 
 * 
 * 
