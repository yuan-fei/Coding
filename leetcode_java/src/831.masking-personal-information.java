...
class Solution {
    ...
    String maskEmail(String s){
        ...
        return String.format("%c*****%c@%s", Character.toLowerCase(parts[0].charAt(0)), Character.toLowerCase(parts[0].charAt(parts[0].length() - 1)), parts[1].toLowerCase());
    }
    ...
    String maskPhone(String s){
        ...
        return String.format("%s***-***-%s", prefix, s.substring(s.length() - 4));
    }
}
// @lc code=end
