 ...
 * Output: 2.65000
 * Explanation:
 * The first 3 dollars you earn are taxed at 50%. You have to pay $3 * 50% =
 * $1.50 dollars in taxes.
 * The next 7 - 3 = 4 dollars you earn are taxed at 10%. You have to pay $4 *
 * 10% = $0.40 dollars in taxes.
 * The final 10 - 7 = 3 dollars you earn are taxed at 25%. You have to pay $3 *
 * 25% = $0.75 dollars in taxes.
 ...
 * Output: 0.25000
 * Explanation:
 * The first dollar you earn is taxed at 0%. You have to pay $1 * 0% = $0
 * dollars in taxes.
 * The second dollar you earn is taxed at 25%. You have to pay $1 * 25% = $0.25
 * dollars in taxes.
 ...
 * Output: 0.00000
 * Explanation:
 * You have no income to tax, so you have to pay a total of $0 dollars in
 * taxes.
 * 
 * 
 * 
...
class Solution {
    public double calculateTax(int[][] brackets, int income) {
        ...
        for(int i = 0; i < brackets.length; i++){
            ...
            ret += Math.max(0, Math.min(income, brackets[i][0]) - last) * brackets[i][1];
        }
        return ret/100;
    }
}
