 ...
 * descendants. You may only upgrade a node if all 3 conditions are
 * true:
 * 
 ...
 * id user to unlock the node num, or false otherwise. If it is possible, the
