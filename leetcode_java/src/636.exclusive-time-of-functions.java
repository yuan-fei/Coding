    ...
    public int[] exclusiveTime(int n, List<String> logs) {
        ...
        for (String log : logs) {
        	...
        	if(parts[1].equals("start")){
        		...
        		int includedTime = 0;
        		while(!funStack.isEmpty()&&!funStack.peek().equals(fun)){
        			funStack.pop();
        			includedTime += resultStack.pop();
        		}
        		int inclusiveTotal = ts - tsStack.pop() + 1;
        		int exclusiveTotal = inclusiveTotal - includedTime;
        		resultStack.push(inclusiveTotal);
        		r[funStack.pop()] += exclusiveTotal;
        		funStack.push(-1);
        	}
