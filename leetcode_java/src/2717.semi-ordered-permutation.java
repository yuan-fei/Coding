 ...
 * Input: nums = [2,1,4,3]
 * Output: 2
 * Explanation: We can make the permutation semi-ordered using these sequence
 * of operations: 
 ...
 * It can be proved that there is no sequence of less than three operations
...
class Solution {
    public int semiOrderedPermutation(int[] nums) {
        ...
        return pos1 + n - 1 - posN - ((posN < pos1) ? 1 : 0);
    }
}
// @lc code=end
