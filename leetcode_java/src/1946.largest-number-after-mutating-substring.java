 ...
 * 
 * You may choose to mutate any substring of num. To mutate a substring,
 ...
 * choosing not to) any substring of num.
 * 
...
class Solution {
    public String maximumNumber(String num, int[] change) {
        ...
        for(char c : num.toCharArray()){
            if((mutated == 0 && change[c - '0'] > (c - '0')) || (mutated == 1 && change[c - '0'] >= (c - '0'))){
                ret.append(change[c - '0']);
                mutated = 1;
            }
            else{
                ret.append(c); 
