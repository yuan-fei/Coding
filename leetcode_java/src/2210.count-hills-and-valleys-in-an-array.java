 ...
 * At index 1: The closest non-equal neighbors of 4 are 2 and 1. Since 4 > 2
 * and 4 > 1, index 1 is a hill. 
 * At index 2: The closest non-equal neighbors of 1 are 4 and 6. Since 1 < 4
 * and 1 < 6, index 2 is a valley.
 * At index 3: The closest non-equal neighbors of 1 are 4 and 6. Since 1 < 4
 * and 1 < 6, index 3 is a valley, but note that it is part of the same valley
 * as index 2.
 * At index 4: The closest non-equal neighbors of 6 are 1 and 5. Since 6 > 1
 * and 6 > 5, index 4 is a hill.
 ...
 * neither a hill nor a valley.
 * At index 2: The closest non-equal neighbors of 5 are 6 and 4. Since 5 < 6
 * and 5 > 4, index 2 is neither a hill nor a valley.
 * At index 3: The closest non-equal neighbors of 5 are 6 and 4. Since 5 < 6
 * and 5 > 4, index 3 is neither a hill nor a valley.
 * At index 4: The closest non-equal neighbors of 4 are 5 and 1. Since 4 < 5
 * and 4 > 1, index 4 is neither a hill nor a valley.
...
class Solution {
    public int countHillValley(int[] nums) {
        ...
        for(int i = 1; i < nums.length - 1; i++){
            if(nums[i] != nums[left] && nums[i + 1] != nums[i]){
                if((nums[i + 1] - nums[i]) * (nums[left] - nums[i]) > 0){
                    cnt++;
