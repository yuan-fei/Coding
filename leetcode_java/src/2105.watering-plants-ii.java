 ...
 * the i^th plant is located at x = i.
 * 
 ...
 * Output: 1
 * Explanation:
 * Both Alice and Bob will reach the middle plant with the same amount of
 * water, so Alice will water it.
 * She will have 1 unit of water when she reaches it, so she will refill her
 * can.
