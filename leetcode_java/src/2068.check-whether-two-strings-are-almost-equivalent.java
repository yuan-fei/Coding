 ...
 * 
 * Given two strings word1 and word2, each of length n, return true if word1
 * and word2 are almost equivalent, or false otherwise.
 * 
 ...
 * - 'd' appears 2 times in word1 and 0 times in word2. The difference is
 * 2.
 * 
 * 
 * 
