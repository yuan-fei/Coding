 ...
 * 
 * 
 * For example, if binary = "001", then all the good subsequences are ["0",
 * "0", "1"], so the unique good subsequences are "0" and "1". Note that
 * subsequences "00", "01", and "001" are not good because they have leading
 * zeros.
 * 
 * 
 * Return the number of unique good subsequences of binary. Since the answer
