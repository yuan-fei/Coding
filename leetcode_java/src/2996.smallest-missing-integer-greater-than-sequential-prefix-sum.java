 ...
 * - 1] + 1. In particular, the prefix consisting only of nums[0] is
 * sequential.
 * 
 ...
 * 6. 6 is not in the array, therefore 6 is the smallest missing integer
 ...
 * 12. 12, 13, and 14 belong to the array while 15 does not. Therefore 15 is
