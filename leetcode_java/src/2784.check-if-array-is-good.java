 ...
 * n + 1 which contains 1 to n - 1 exactly once, plus two occurrences of n).
 ...
 * Output: true
 * Explanation: Since the maximum element of the array is 3, the only candidate
 * n for which this array could be a permutation of base[n], is n = 3. It can
 * be seen that nums is a permutation of base[3] = [1, 2, 3, 3] (by swapping
 * the second and fourth elements in nums, we reach base[3]). Therefore, the
 * answer is true.
 * 
 * Example 3:
 * 
 ...
 * n for which this array could be a permutation of base[n], is n = 1. It can
 * be seen that nums is a permutation of base[1] = [1, 1]. Therefore, the
 * answer is true.
 * 
 * Example 4:
 * 
...
class Solution {
    public boolean isGood(int[] nums) {
        ...
        Arrays.sort(nums);
        return Arrays.equals(nums, target);
    }
}
// @lc code=end
