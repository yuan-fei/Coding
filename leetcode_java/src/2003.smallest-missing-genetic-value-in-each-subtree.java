 ...
 *
 * There is a family tree rooted at 0 consisting of n nodes numbered 0 to n -
 * 1. You are given a 0-indexed integer array parents, where parents[i] is the
 ...
 * Output: [7,1,1,4,2,1]
 * Explanation: The answer for each subtree is calculated as follows:
 * - 0: The subtree contains nodes [0,1,2,3,4,5] with values [5,4,6,2,1,3]. 7
 * is the smallest missing value.
