/*
 * @lc app=leetcode id=2286 lang=java
 *
 ...
 * row and seat number (respectively) of the first seat being allocated to the
 * k members of the group, who must sit together. In other words, it returns
 * the smallest possible r and c such that all [c, c + k - 1] seats are valid
 * and empty in row r, and r <= maxRow. Returns [] in case it is not possible
 ...
 * 
 * Explanation
 * BookMyShow bms = new BookMyShow(2, 5); // There are 2 rows with 5 seats
 * each 
 ...
 * ⁠                  // The group books seat 4 of row 0 and seats [0, 3] of
 * row 1. 
