 ...
 * with a value val in the range [1, 2^n - 1 - 1] has two children where:
 * 
 * 
 ...
 * Output: [4,5,3]
 * Explanation: The diagrams above show the tree of 2^3 - 1 nodes. Nodes
 ...
 * nodes [5,2,1,3]. Thus answer to the first query is 4. We delete the added
 ...
 * nodes [2,1,3]. Thus answer to the third query is 3. We delete the added
 * edge.
 * 
 * 
 * Example 2:
 ...
 * Output: [2]
 * Explanation: The diagram above shows the tree of 2^2 - 1 nodes. Nodes
 * colored in red describe the nodes in the cycle after adding the edge.
 * - After adding the edge between nodes 1 and 2, the graph contains a cycle of
 * nodes [2,1]. Thus answer for the first query is 2. We delete the added
 * edge.
 * 
 * 
 * 
