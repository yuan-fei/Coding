...
public class TopologicalSort {
	...
	public static void main(String[] args) {
		...
		int[][] dependency1 = new int[][] { new int[] { 1, 2 }, new int[] { 0, 2 }, new int[] { 3, 2 },
				new int[] { 1, 3 } };
		int[][] dependency2 = new int[][] { new int[] { 1, 2 }, new int[] { 0, 2 }, new int[] { 2, 3 },
	...
	public static boolean topologicalSort(int numVertexes, int[][] dependency, List<Integer> output) {
	...
	private static boolean topologicalSortDfsHelper(boolean[][] matrix, int[] visited, int currentV,
			List<Integer> output) {
